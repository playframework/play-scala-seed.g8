...
lazy val phantomDeps = (project in file("phantom-deps"))
  ...
  .settings(
    publish / skip := true,
    scalaVersion := "2.13.18", // ! Also update in src/main/g8/[build.mill|build.sbt] !
    libraryDependencies ++= Seq(
      "org.playframework.twirl" %% "twirl-compiler" % "2.0.9", // ! Also update in src/main/g8/build.mill !
      "org.scalatestplus.play" %%"scalatestplus-play" % "7.0.2", // ! Also update in src/main/g8/build.sbt !
      "org.playframework" %% "play-routes-compiler" % "3.0.11", // ! Also update in src/main/g8/[build.mill|project/plugins.sbt] !
