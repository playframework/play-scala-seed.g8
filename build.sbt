...
lazy val phantomDeps = (project in file("phantom-deps"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "com.typesafe.play" %% "twirl-compiler" % "1.6.9", // ! Also update in src/main/g8/build.sc !
      "org.scalatestplus.play" %% "scalatestplus-play" % "6.0.1", // ! Also update in src/main/g8/build.sbt !
      "com.typesafe.play" %% "play-routes-compiler" % "2.9.8", // ! Also update in src/main/g8/[build.sc|project/plugins.sbt] !
