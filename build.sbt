...
lazy val phantomDeps = (project in file("phantom-deps"))
  ...
  .settings(
    publish / skip := true,
    scalaVersion := "3.9.0", // ! Also update in src/main/g8/[build.sc|build.sbt] !
    libraryDependencies ++= Seq(
      ...
      "com.typesafe.play" %% "play-routes-compiler" % "2.9.11", // ! Also update in src/main/g8/[build.sc|project/plugins.sbt] !
